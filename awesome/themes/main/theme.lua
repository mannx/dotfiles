...
theme.fg_focus                                  = "#ff0000" -- "#A77AC4"
theme.fg_urgent                                 = "#b74822"
theme.bg_normal                                 = "#282a36"
theme.bg_focus                                  = theme.bg_normal -- "#2f8ec2" -- "#FF79C6"
theme.bg_urgent                                 = "#3F3F3F"
theme.taglist_fg_focus                          = "#2f8ec2" -- lighter blue -- "#282a36"
theme.tasklist_bg_focus                         = "#000000"
theme.tasklist_fg_focus                         = "#A77AC4"
theme.border_width                              = 2
theme.border_normal                             = "#064e91" -- darkish blue
theme.border_focus                              = "#2f8ec2" -- lighter blue "#F07178"
...
-- colour used for the right most status bar
local sbCol1 = "#3e87ed"
local sbCol2 = "#6fc2f2"
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            arrow("alpha", sbCol1),
            wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, 3, 6), sbCol1),
            arrow(sbCol1, sbCol2),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), sbCol2),
            --arrow("#A77AC4", "#7197E7"),
            ...
            -- arrow(sbCol2, sbCol1),
            -- wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, 4, 4), sbCol1),
            arrow(sbCol2, sbCol1),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), sbCol1),
            arrow(sbCol1, sbCol2),
            ...
            -- arrow("#A77AC4", "#7197E7"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), sbCol2),
            arrow(sbCol2, "alpha"),
            --]]
            s.mylayoutbox,
        },
